...
public class VentanaCrearProveedorMenuVender extends JFrame {
	 ...
	 * Create the frame.
	 */
	public VentanaCrearProveedorMenuVender(Conexion conexion, Usuario user,long turno) {
		...
		setIconImage(Toolkit.getDefaultToolkit()
				.getImage(VentanaCrearProveedorMenuVender.class.getResource("/imagenes/Logo viejo.png")));
...
//		setBounds(100, 100, 450, 325);
		...
		label.setIcon(new ImageIcon(VentanaCrearProveedorMenuVender.class.getResource("/imagenes/Logo.png")));
