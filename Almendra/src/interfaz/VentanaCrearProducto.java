...
public class VentanaCrearProducto extends JFrame {
	 ...
	 * Create the frame.
	 */
	public VentanaCrearProducto(Conexion conexion, Usuario user) {

		this.conexion = conexion;
		this.user = user;

		setIconImage(Toolkit.getDefaultToolkit()
				.getImage(VentanaCrearProducto.class.getResource("/imagenes/Logo viejo.png")));
...
//		panel.add(btnEliminar);
		...
		label.setIcon(new ImageIcon(VentanaCrearProducto.class.getResource("/imagenes/Logo.png")));
