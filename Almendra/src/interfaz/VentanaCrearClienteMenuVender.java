...
public class VentanaCrearClienteMenuVender extends JFrame {
	 ...
	 * Create the frame.
	 */
	public VentanaCrearClienteMenuVender(Conexion conexion, Usuario user, long turno) {
		...
		setIconImage(Toolkit.getDefaultToolkit()
				.getImage(VentanaCrearClienteMenuVender.class.getResource("/imagenes/Logo viejo.png")));
...
//		setBounds(100, 100, 450, 325);
		...
		label.setIcon(new ImageIcon(VentanaCrearClienteMenuVender.class.getResource("/imagenes/Logo.png")));
