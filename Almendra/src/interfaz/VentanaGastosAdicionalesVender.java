...
public class VentanaGastosAdicionalesVender extends JFrame {
	 ...
	 * Create the frame.
	 */
	public VentanaGastosAdicionalesVender(Conexion conexion, Usuario user,long turno) {
...
//		setBounds(100, 100, 586, 300);
		...
		btnVolver.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent e) {
				VentanaMenuAdministrarVender ajuste = new VentanaMenuAdministrarVender(conexion, user,turno);
